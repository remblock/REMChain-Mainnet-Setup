...
> This command line is used for removing a key from your wallet. Each time you remove a key from your wallet, you will be promted for your default wallet password which can be found here `cat walletpass`

...
rm -f ./Install-1.sh 
su "$username" sh -c "sudo -S wget https://github.com/SooSDExZ/REMChain-Testnet-Guide/raw/master/Install-2.sh && sudo -S wget https://github.com/SooSDExZ/REMChain-Testnet-Guide/raw/master/Install-3.sh && sudo -S chmod u+x Install-2.sh && sudo chmod u+x Install-3.sh && sudo -S ./Install-2.sh"
